...
<?php
              ...
              $id="1";
             $rows=$getCredit->get_by_id('more','id',$id);
             foreach($rows as $row)
             {
...
header("location:more?saved=1");
 ...
 <?php if($row['watermark']!=''){?>
    <img src="../assets/images/<?php echo $row['watermark'];?>" class="imgavt" alt="Logo" style="width:100px;"> <a href="remove?image=<?php echo $row['watermark'];?>&to=more&folder=../assets/images/&table=more&id=1&col=watermark&colid=id" onClick='return confirm("Are you sure you want to remove?")' ><button class="btn btn-danger" type="button">Remove</button></a>
    <?php } else { ?> 
<img src="uploads/noimagecx.png" class="imgavt" alt="Logo" style="width:100px;">
    <?php } ?> 
    <br>
<label for="exampleInputEmail1">Change Watermark </label>
    ...
    <a href="remove?image=<?php echo $row['iso'];?>&to=more&folder=../assets/images/&table=more&id=1&col=iso&colid=id" onClick='return confirm("Are you sure you want to remove?")' ><button class="btn btn-danger" type="button">Remove</button></a>
    <?php } else { ?> 
<img src="uploads/noimagecx.png" class="imgavt" alt="Logo" style="width:100px;">
    <?php } ?> 
   <br>

<label for="exampleInputEmail1">Change Home image</label>
    ...
    <label for="exampleInputEmail1">Certificate ICON</label>
    <img src="../assets/images/<?php echo $row['certified'];?>" class="imgavt" alt="Logo" style="width:100px;">
    <a href="remove?image=<?php echo $row['certified'];?>&to=more&folder=../assets/images/&table=more&id=1&col=certified&colid=id" onClick='return confirm("Are you sure you want to remove?")' ><button class="btn btn-danger" type="button">Remove</button></a>
    <?php } else { ?> 
<img src="uploads/noimagecx.png" class="imgavt" alt="Logo" style="width:100px;">
    <?php } ?> 
   
<br>
<label for="exampleInputEmail1">Change Certificatre ICON</label>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group" style="border:5px solid #33CC00 ;border-style: dotted;">
            <?php if($row['stamp']!=''){?>
    <label for="exampleInputEmail1">Public Certificate Background </label>
    <img src="../assets/images/<?php echo $row['stamp'];?>" class="imgavt" alt="Logo" style="width:100px;">
   <a href="remove?image=<?php echo $row['stamp'];?>&to=more&folder=../assets/images/&table=more&id=1&col=stamp&colid=id" onClick='return confirm("Are you sure you want to remove?")' ><button class="btn btn-danger" type="button">Remove</button></a>
    <?php } else { ?> 
<img src="uploads/noimagecx.png" class="imgavt" alt="Logo" style="width:100px;">
    <?php } ?> 
<br>
<label for="exampleInputEmail1">Change Public Certificate Background</label>
    ...
    <label for="exampleInputEmail1">404 page Image</label>
    <img src="../assets/images/<?php echo $row['signature'];?>" class="imgavt" alt="Logo" style="width:100px;">
    <a href="remove?image=<?php echo $row['signature'];?>&to=more&folder=../assets/images/&table=more&id=1&col=signature&colid=id" onClick='return confirm("Are you sure you want to remove?")' ><button class="btn btn-danger" type="button">Remove</button></a>
    <?php } else { ?> 
<img src="uploads/noimagecx.png" class="imgavt" alt="Logo" style="width:100px;">
    <?php } ?> 
...
<label for="exampleInputEmail1">Change 404 page image</label>
