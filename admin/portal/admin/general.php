...
<br>
 ...
 <div class="clearfix"></div>
 <div style="border:5px solid #33CC00 ;border-style: dotted; padding: 10px;">
...
<div class="col-md-12 col-sm-12 ">
        <label>Registration ID or more </label>
        <input type='text' name='reg' class="form-control" value='<?php echo $reg; ?>'> 

         <small>eg-Ministry of Corporate Affairs (Govt. of xxxx ) Govt. CIN. No. UXXXXXUP2022NPL1XXX TAN. MXTGXXXXX(Below Title ) </small>
      <br>  
</div>
...
<div class="col-md-12 col-sm-12 ">
   <input type='hidden' name='id' value='1'> 
      <label>Website Email </label>
        ...
        <input type='email' name='from_email' class="form-control" value='<?php echo $from_email;?>'> 
...
<div class="col-md-12 col-sm-12 ">
        <label>Address</label>
        <textarea name="web_desc" class="form-control" rows="5"><?php echo $web_desc; ?></textarea>
...
<div class="col-md-12 col-sm-12 ">
   ...
   <input type='hidden' name='id' value='1'> 
      <label>Registration starts from the numbers </label>
        ...
        <input type='number' name='web_tags' class="form-control" value='<?php echo $web_tags;?>'> 
